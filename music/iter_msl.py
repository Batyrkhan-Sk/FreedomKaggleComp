"""JOINT (min_samples_leaf, max_iter) OPTIMUM.

msl=1000 was +0.00114 at 200 iters but only +0.00083 at 400 -- the gain SHRINKS as
iterations rise, so the two knobs interact and the joint optimum is likely below 400
iters once leaves are coarser. Same "less fitting" direction, other knob.
Reference: msl=1000 x 400 iters x 5 seeds = ENSEMBLE-5 0.38173 (msl=200 x 400 = 0.38090).
...
print(f"  ENSEMBLE-5   {e:.5f}   (msl1000x400 = 0.38173, msl200x400 = 0.38090)")
